...
public class UtilsTest {
    ...
    public void search() {
        ...
        AbstractPurchase equalsFive = new PriceDiscountPurchase(product, 5, new Byn(30));
        AbstractPurchase equalsFour = new PriceDiscountPurchase(product, 3, new Byn(20));
        AbstractPurchase equalsTen = new PercentDiscountPurchase(product, 8, 5.5);
        AbstractPurchase equalsNine = new TransportedPurchase(product, 8, new Byn(150));
        AbstractPurchase equalsThree = new PriceDiscountPurchase(product, 3, new Byn(30));
